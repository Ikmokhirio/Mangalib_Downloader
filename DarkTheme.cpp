...
DarkTheme::DarkTheme(std::vector<Daedalus::ImGuiFont> primaryFonts, std::vector<Daedalus::ImGuiFont> additionalFonts)
...
std::vector<ImFont*> DarkTheme::ApplyTheme(ImGuiIO* io, ImGuiStyle* style)
{
  ...
  colors[ImGuiCol_WindowBg] = ImVec4(0.13f, 0.14f, 0.17f, 0.70f);
  colors[ImGuiCol_ChildBg] = ImVec4(0.13f, 0.14f, 0.17f, 0.70f);
